...
# calibration
calib_image_dirpath = osp.join(osp.dirname(__file__), "../data/pictures/capture/output/")
calib_image_format = "png"
calib_result_save_format = "pkl"
calib_result_savedirpath = osp.join(osp.dirname(__file__), "../data/result")
...
param_filepath = osp.join(osp.dirname(__file__), "../data/result/camera_param.pkl")

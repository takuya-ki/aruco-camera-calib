...
Camera calibration tool with [ArUco](https://www.uco.es/investiga/grupos/ava/node/26) library.
...
![sample board](data/board/sample_board.png)
...
```bash
python src/marker_pose_estimation_images.py --dict 'DICT_4X4_250' --marker_length 0.02 --in_dir ../data/pictures/sample_marker --out_dir ../data/pictures/sample_marker/result --camera_param ../data/result/camera_param.pkl
```

```bash
python src/marker_pose_estimation_videos.py --dict 'DICT_4X4_250' --marker_length 0.02 --in_dir ../data/videos/sample_marker --out_dir ../data/videos/sample_marker/result --camera_param ../data/result/camera_param.pkl
```
